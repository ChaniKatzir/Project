...
exports.findAll=async(req,res)=>{
    ...
    p=cr(p,"$last_name$",req.body.last_name);
    p=cr(p,"yearbook",req.body.yearbook);
    p=cr(p,"id_institute_student",req.body.id_institute_student);
    p=cr(p,"$phone_number$",req.body.phone_number); 
    p=cr(p,"$celphone_number$",req.body.celphone_number);
    p=cr(p,"id_person_student",req.body.id_person_student); 
