...
const Student = () => {
  ...
  const create = [["מספר זהות", "שם פרטי", "שם משפחה", "כתובת מגורים", "מספר טלפון", "מספר פלאפון", "כתובת מייל", "מספר בנק", "מספר סניף", "מספר חשבון", "קוד אימות", "שנתון", "קוד מוסד", "שכר לימוד"],
  ["id_person", "first_name", "last_name", "address", "phone_number", "celphone_number", "Email", "id_bank", "id_branch", "num", "password", "yearbook", "id_institute_student", "tuition"],
  ...
  const deletefunc = async () => {
    perobj = await deleteData(`student/${id}`)
